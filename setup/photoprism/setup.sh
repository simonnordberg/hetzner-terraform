...
SETUP_BASE_URL="https://raw.githubusercontent.com/simonnordberg/hetzner-terraform/main/setup/photoprism"
...
# detect public server ip address (with forced IPv4)
PUBLIC_IP=$(curl -sfSL -4 ifconfig.me)

echo "Downloading configuration..."

# download service config
COMPOSE_CONFIG=$(curl -fsSL $SETUP_BASE_URL/docker-compose.yml)
...
curl -fsSL $SETUP_BASE_URL/traefik.yaml > /opt/photoprism/traefik.yaml
